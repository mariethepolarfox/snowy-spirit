...
class ConfigScreen : Overlay(null) {
    ...
    private val MOON_LOCATION = ResourceLocation.withDefaultNamespace("textures/environment/moon_phases.png")
    ...
    override fun init() {
                    ...
                    builder.withOption("Sunrise")
                        ...
                        .withRenderer { string, bool ->
                            ...
                            WidgetRenderers.layered(
                                ...
                                texture(
                                    ResourceLocation.withDefaultNamespace("textures/item/clock_$timeString.png")
                                )
                            )
                        }
                        .withCallback { newVal ->
        ...
        if (Config.moonPhaseChanger) {
            ...
            moonRenderer = Widgets.renderable { graphics, context, _ ->
                renderMoonSprite(Config.moonPhase.ordinal, graphics, context)
            }
        }
    ...
    fun <T : AbstractWidget> texture(identifier: ResourceLocation, width: Int = 16, height: Int = 16, yOffset: Int = -1) : WidgetRenderer<T> {
    ...
    private fun renderMoonSprite(i: Int, graphics: GuiGraphics, context: WidgetRendererContext<BaseWidget>) {
        val j = i % 4
        val k = (i / 4) % 2
        val u0 = j * 64
        val v0 = k * 64
        val xPos = context.x + (context.width - 64) / 2
        val yPos = context.y
